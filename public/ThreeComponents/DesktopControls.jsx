...
const DesktopControls = ({initialCameraPosition, initialCameraRotation, spacePressed}) => {
  ...
  const moveSpeed = 20; // Adjust this value to control movement speed
  ...
  useEffect(() => {
    if (PointerLocksRef.current) {
      ...
      PointerLocksRef.current.getObject().rotation.set(
        0,
